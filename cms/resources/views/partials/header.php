...
<a class="navbar-brand" href="./sillingdashboard">Silling dashboard</a>
<a class="navbar-brand" href="./stockmangment">Stock mangment</a>
<a class="navbar-brand" href="">Transaction</a>
 <a class="navbar-brand"  href="/logout">Logout</a>
<a href="./profile"><img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" width="40" height="23" class="rounded-circle  align-text-top">
</nav>
<?php endif ?>
<?php if (isset($_SESSION['user'])) : ?>
                <?php if($_SERVER['REQUEST_URI']!=='/profiles'):?>
        ...
        <div class="col-2 admin-links">
            ...
            <?php endif?>
<?php if($_SERVER['REQUEST_URI']=='/stockmangment'):?>
               <?php
                if (Helper::check_permission(['item:read'])) : ?>
                    <li class="list-group-item">
                        <a href="/items">All Item</a>
                    </li>
                <?php endif;
                ...
                ?>
                    ...
                    <?php endif;
                   if (Helper::check_permission(['item:edit'])) :
                    ?>
                        <li class="list-group-item">
                            <a href="/items/edit">Create item</a>
                        </li>
                    <?php endif;
endif;?>
                ...
                <?php endif; ?>
<?php if($_SERVER['REQUEST_URI']=='/sillingdashboard'):?>
    <?php
                ...
                ?>
                    ...
                    <?php endif;
                     if (Helper::check_permission(['transaction:create'])) :
                        ?>
                            <li class="list-group-item">
                                <a href="/transactions/delete">Deleate Transactions</a>
                            </li>
                    <?php endif?>
<?php endif?>
